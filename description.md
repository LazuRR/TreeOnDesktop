...
Графический интерфейс пользователя на данной стадии разработки будет представлен в виде мокапов (ссылка на гит).
...
-Просмотреть актуальную сводку погоды;
-Просмотреть и выбрать авиабилеты для выбранного города;
-Узнать основную информацию о городе;
-Посмотреть расположение города на карте
-Посмотреть погодную карту
-Выбрать место проживания из информации, предоставленной [Booking.com](https://www.booking.com/index.ru.html?aid=397594;label=gog235jc-1DCAEoggI46AdIM1gDaCWIAQGYASG4ARfIAQzYAQPoAQGIAgGoAgO4ArO2zuwFwAIB;sid=795f9c6b1128523c81ef59c5fae36f5f;keep_landing=1&sb_price_type=total&)
-Зайти на мой гитхаб и оценить проект

### 3.2. Нефункциональные требования <a name="3.2"></a>

-Удобство использования
-Исполнение своих функций как сайта
